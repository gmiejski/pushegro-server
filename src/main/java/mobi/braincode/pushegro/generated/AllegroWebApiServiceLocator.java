...
public class AllegroWebApiServiceLocator extends org.apache.axis.client.Service implements mobi.braincode.pushegro.generated.AllegroWebApiService {
    ...
    public mobi.braincode.pushegro.generated.AllegroWebApiPortType getAllegroWebApiPort() throws javax.xml.rpc.ServiceException {
    ...
    public mobi.braincode.pushegro.generated.AllegroWebApiPortType getAllegroWebApiPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mobi.braincode.pushegro.generated.AllegroWebApiBindingStub _stub = new mobi.braincode.pushegro.generated.AllegroWebApiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mobi.braincode.pushegro.generated.AllegroWebApiPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mobi.braincode.pushegro.generated.AllegroWebApiBindingStub _stub = new mobi.braincode.pushegro.generated.AllegroWebApiBindingStub(new java.net.URL(AllegroWebApiPort_address), this);
                _stub.setPortName(getAllegroWebApiPortWSDDServiceName());
                return _stub;
            }
        }
